...
const Calculator = () => {
    ...
    const handleChange = (e) => {
        ...
        setState({ ...state, [name]: value, error: value === '0' ? "Can,t be zero" : '' });
    };
                    ...
                    <div className='left-side'>
                        <div className='input-container'>
                            ...
                            <span style={{ position: 'relative' }}>
                                ...
                                <input
                                    type='text'
                                    style={{ paddingRight: "30px", backgroundColor: '#F3F8FB', width: '90%', height: '20px', textAlign: 'right' }}
                                    id='bill'
                                    name='bill'
                                    value={state.bill}
                        ...
                        <div className='input-container'>
                            ...
                            <div style={{ position: "relative",display:'flex',justifyContent:'space-between' }}>
                                ...
                                <input type='text' name='people' value={state.people} onChange={handleChange} style={{ paddingRight: "30px", backgroundColor: '#F3F8FB', width: '90%', height: '20px', textAlign: 'right' }} />
                            </div>
